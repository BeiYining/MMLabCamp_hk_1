...
data = dict(
    ...
    train=dict(
        type='ImageNet',
        data_prefix='/home/yangshuo/past_comp/data/flower/work_tmp/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='RandomResizedCrop', size=224),
            dict(type='RandomFlip', flip_prob=0.5, direction='horizontal'),
        ...
        ann_file='/home/yangshuo/past_comp/data/flower/work_tmp/train.txt',
        classes='/home/yangshuo/past_comp/data/flower/work_tmp/classes.txt'),
    val=dict(
        type='ImageNet',
        data_prefix='/home/yangshuo/past_comp/data/flower/work_tmp/val',
        ann_file='/home/yangshuo/past_comp/data/flower/work_tmp/val.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='Resize', size=(256, -1)),
            dict(type='CenterCrop', crop_size=224),
